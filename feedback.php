...
<a href="index.php" class="pull-right btn sub1 title3"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Начало</a>&nbsp;
</div></div>
...
<h2 align="center" style="font-family:'typo'; color:#000066">ОБРАТНА ВРЪЗКА</h2>
...
<div class="row">
<div class="col-md-3"><b>Име:</b><br /><br /><br /><b>Тема:</b></div>
<div class="col-md-9">
<!-- Text input-->
<div class="form-group">
  <input id="name" name="name" placeholder="Име" class="form-control input-md" type="text"><br />    
   <input id="name" name="subject" placeholder="Тема" class="form-control input-md" type="text">    
</div>
</div>
</div><!--End of row-->

<div class="row">
<div class="col-md-3"><b>Имейл адрес:</b></div>
<div class="col-md-9">
<!-- Text input-->
<div class="form-group">
  <input id="email" name="email" placeholder="Имейл" class="form-control input-md" type="email">    
...
<div class="form-group"> 
<textarea rows="5" cols="8" name="feedback" class="form-control" placeholder="Опиши темата..."></textarea>
</div>
<div class="form-group" align="center">
<input type="submit" name="submit" value="Изпрати" class="btn btn-primary" />
</div>
</form>';}?>
</div><!--col-md-6 end-->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          ...
          <div class="col-md-5">
          <a style="color:#202020; font-family:'typo'; font-size:18px">Клуб "Програмиране за интернет"</a>
		    </p>
      </div>
